...
- Give your zap a name, example: "Automatic deploy Project--cake" and make sure your zap is turned on
...
- Now go to the [form settings](https://app.netlify.com/sites/project--cake/settings/forms#outgoing-notifications) in you Netlify project
